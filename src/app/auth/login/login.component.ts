...
export class LoginComponent implements OnInit {
  ...
  loginForm = this.fb.group({
    username: new FormControl<string>('', Validators.compose([Validators.required, Validators.maxLength(60)])),
    password: new FormControl<string>('', Validators.compose([Validators.required, Validators.maxLength(100)])),
  });
